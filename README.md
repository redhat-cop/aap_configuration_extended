...
This Ansible collection extends the `infra.aap_configuration` collection by providing extra functionalities that allows advanced operations on the AWX or Ansible Automation Platform Configuration as Code.
...
|                                      Collection Name                                       |                      Purpose                      |
|:------------------------------------------------------------------------------------------:|:-------------------------------------------------:|
| [AAP Configuration](https://github.com/redhat-cop/infra.aap_configuration)                 | Easy interaction with an AWX or Ansible Automation Platform via Ansible roles using the AWX/Controller collection modules |
